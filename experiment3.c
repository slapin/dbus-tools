...
int main(int argc, char *argv[])
{
...
#if 0
	proxy = gpsd_org_gpsd_proxy_new_for_bus_sync(G_BUS_TYPE_SYSTEM,
	...
	g_signal_connect(proxy, "fix", G_CALLBACK(fix_signal), NULL);
	g_signal_connect(proxy, "telemetry", G_CALLBACK(fix_signal), NULL);
#endif
